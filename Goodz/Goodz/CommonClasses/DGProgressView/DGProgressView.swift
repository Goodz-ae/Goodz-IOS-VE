...
class DGProgressView : UIView {
    ...
    func showLoader(showTo : UIView) {
        ...
        proggressView.layer.shadowColor = UIColor.black.cgColor
        ...
        NSLayoutConstraint.activate(
            [
                proggressView.centerYAnchor.constraint(equalTo: showTo.safeAreaLayoutGuide.centerYAnchor, constant: 0),
                proggressView.centerXAnchor.constraint(equalTo: showTo.safeAreaLayoutGuide.centerXAnchor),
