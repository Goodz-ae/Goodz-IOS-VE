...
@IBDesignable open class RangeSeekSlider: UIControl {
    ...
    private let sliderBlackLine: CALayer = CALayer()
    ...
    func updateHandleUI() {
        if isLeftCenter == false{
            leftHandle.cornerRadius = handleDiameter / 2.0
            rightHandle.cornerRadius = 2
            leftHandle.backgroundColor = UIColor.sliderRed.cgColor
            leftHandle.borderColor = UIColor.sliderRed.cgColor
            rightHandle.backgroundColor = UIColor.themeBlack.cgColor
            rightHandle.borderColor = UIColor.themeBlack.cgColor
            
            sliderLine.backgroundColor = UIColor.lightGray.cgColor
        }else{
            leftHandle.cornerRadius = 2
            rightHandle.cornerRadius = handleDiameter / 2.0
            rightHandle.backgroundColor = UIColor.sliderRed.cgColor
            rightHandle.borderColor = UIColor.sliderRed.cgColor
            leftHandle.backgroundColor = UIColor.themeBlack.cgColor
            leftHandle.borderColor = UIColor.themeBlack.cgColor
        ...
        if selectedMinValue == 0 && selectedMaxValue == 0 {
            ...
            sliderLineBetweenHandles.isHidden = true
            sliderBlackLine.isHidden = true
        } else if selectedMinValue == 0 || selectedMaxValue == 0 {
            leftHandle.isHidden = true
            minLabel.isHidden = true
            ...
            if isLeftCenter == false {
                sliderLineBetweenHandles.isHidden = true
                sliderBlackLine.isHidden = false
            }else{
                sliderLineBetweenHandles.isHidden = false
                sliderBlackLine.isHidden = true
            }
        } else {
    ...
    private func setup() {
        ...
        layer.addSublayer(sliderBlackLine)
...
//        rightHandle.cornerRadius = handleDiameter / 2.0
    ...
    private func updateLineHeight() {
        ...
        sliderBlackLine.cornerRadius = sliderLine.cornerRadius
    ...
    private func updateColors() {
        ...
        if let initialColor = initialColor?.cgColor, isInitial {
            ...
            sliderBlackLine.backgroundColor = initialColor
            ...
            leftHandle.borderColor = UIColor.thumbMax.cgColor
            rightHandle.backgroundColor = color
            rightHandle.borderColor = UIColor.thumbMin.cgColor
        } else {
            ...
            sliderBlackLine.backgroundColor = UIColor.themeBlack.cgColor
    ...
    private func updateHandlePositions() {
        ...
        if isLeftCenter == false{
            sliderLineBetweenHandles.frame = CGRect(x: 0,
                                                    y: sliderLine.frame.minY,
                                                    width: leftHandle.position.x,
                                                    height: lineHeight)
            sliderBlackLine.frame = CGRect(x: 0,
                                           y: sliderLine.frame.minY,
                                           width: rightHandle.position.x,
                                           height: lineHeight)
        }else{
